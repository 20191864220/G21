...
int main()
{
	...
	printf("If you want to add a student's dates,please enter 8\n"); 
	printf("If you want to save the date,please enter 9.\n"); 
	printf("If you want to read the date,please enter 10.\n");  
